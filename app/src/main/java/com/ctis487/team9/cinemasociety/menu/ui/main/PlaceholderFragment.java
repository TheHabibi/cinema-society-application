...
import com.ctis487.team9.cinemasociety.menu.MyRecycleAdapter;
...
recyclerView = root.findViewById(R.id.recyclerViewFragment);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(root.getContext()));
        MyRecycleAdapter adapter = new MyRecycleAdapter(root.getContext(),eventsListRecycle);
